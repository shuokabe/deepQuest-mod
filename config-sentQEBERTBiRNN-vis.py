def load_parameters():
    ...
    INPUTS_IDS_DATASET = ['source_text', 'source_text_tok', 'source_text_mask', 'target_text', 'target_text_tok', 'target_text_mask', 'visual_feature']     # Corresponding inputs of the dataset
    ...
    INPUTS_IDS_MODEL = ['source_text', 'source_text_tok', 'source_text_mask', 'target_text', 'target_text_tok', 'target_text_mask', 'visual_feature']     # Corresponding inputs of the dataset
    ...
    # Model parameters
    # Perictor+Estimator
    MODEL_TYPE = 'EncBertSentVis'                 # Model to train. See model_zoo() for the supported architectures
    ...
    VISUAL_FEATURE_STRATEGY = 'embed'                  #('embed', 'annot', 'last', 'state') supported
    VISUAL_FEATURE_METHOD = 'mult'                     # ('concat', 'mult', 'mult-mult') supported
    ONE_SIDE = False
