def load_parameters():
    ...
    INPUTS_IDS_DATASET = ['source_text', 'source_text_tok', 'source_text_mask', 'target_text', 'target_text_tok', 'target_text_mask']     # Corresponding inputs of the dataset
    ...
    INPUTS_IDS_MODEL = ['source_text', 'source_text_tok', 'source_text_mask', 'target_text', 'target_text_tok', 'target_text_mask']     # Corresponding inputs of the dataset
